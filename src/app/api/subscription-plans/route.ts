...
const PLAN_FIELDS =
  'id, code, name, description, plan_scope, billing_cycle, price, currency, max_school_admins, max_teachers, max_students, max_line_notifications, enabled_features, is_active, sort_order, created_at, updated_at';
