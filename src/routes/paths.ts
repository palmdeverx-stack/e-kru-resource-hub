...
export const paths = {
  legal: {
    ...
    copyrightTakedown: '/copyright-takedown-policy',
    refundPolicy: '/refund-policy',
    cookiePolicy: '/cookie-policy',
    center: '/legal',
    digitalProductLicense: '/legal/digital-product-license',
    paymentPayoutPolicy: '/legal/payment-payout-policy',
    productContentPolicy: '/legal/product-content-policy',
    complaintDisputePolicy: '/legal/complaint-dispute-policy',
    childDataPolicy: '/legal/child-student-data-policy',
    dataProcessingAgreement: '/legal/data-processing-agreement',
    subscriptionPolicy: '/legal/subscription-renewal-policy',
    productSubmissionTerms: '/legal/product-submission-terms',
  ...
  marketplace: {
    ...
    cart: '/cart',
    checkout: '/checkout',
    payment: (id: string) => `/checkout/payment/${id}`,
    dashboard: '/dashboard',
    dashboardProducts: '/dashboard/products',
    dashboardCart: '/dashboard/cart',
    dashboardCheckout: '/dashboard/checkout',
    dashboardPayment: (id: string) => `/dashboard/payment/${id}`,
    dashboardCheckoutSuccess: '/dashboard/checkout/success',
    marketingOverview: '/dashboard/marketing-overview',
    sellerApprovals: '/dashboard/seller-approvals',
    sellerApproval: (id: string) => `/dashboard/seller-approvals/${id}`,
    sellerAccounts: '/dashboard/seller-accounts',
    sellerAccount: (id: string) => `/dashboard/seller-accounts/${id}`,
    productApprovals: '/dashboard/product-approvals',
    categories: '/dashboard/master/categories',
    mediaTypes: '/dashboard/master/media-types',
    saleTypes: '/dashboard/master/sale-types',
    mediaReviewRules: '/dashboard/master/media-review-rules',
    orderFinanceTypes: '/dashboard/master/order-finance-types',
    reportReasons: '/dashboard/master/report-reasons',
    gradeLevels: '/dashboard/master/grade-levels',
    curricula: '/dashboard/master/curricula',
    tags: '/dashboard/master/tags',
    ...
    purchase: (id: string) => `/dashboard/purchases/${id}`,
    ...
    sellerShipping: '/dashboard/seller/shipping',
    sellerLineSettings: '/dashboard/seller/settings/line',
    sellerLineGuide: '/dashboard/seller/settings/line/guide',
    sellerSetup: '/dashboard/seller/setup',
    productNew: '/dashboard/seller/products/new',
